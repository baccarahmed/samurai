 ...
 */
function SmokeyBackground({ backdropBlurAmount = "sm", color = "#fff", // Default purple color
className = "", }) {
    ...
    useEffect(() => {
        ...
        const render = () => {
            ...
            // Only set uniforms if the locations are valid
            ...
            if (iMouseLocation) gl.uniform2f(iMouseLocation, isHovering ? mousePosition.x : 0, isHovering ? height - mousePosition.y : 0);
            if (uColorLocation) gl.uniform3f(uColorLocation, r, g, b);
