          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-4">
                Get exclusive access to new products, athlete insights, and special offers
              </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              Premium athletic nutrition designed for champions. Science-backed supplements 
              to elevate your performance and achieve your fitness goals.
            </p>
