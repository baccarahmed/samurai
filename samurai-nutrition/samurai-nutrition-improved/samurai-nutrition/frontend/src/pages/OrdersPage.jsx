...
const OrdersPage = () => {
  ...
  // Les états showCreateOrder et newOrder ont été supprimés car le bouton "Passer Commande" a été supprimé
  ...
  const fetchCartItems = async () => {
    // Simuler des articles dans le panier pour la démo
    // En réalité, ceci viendrait d'une API de panier
    setCartItems([
      { product_id: 1, name: 'Whey Protein Isolate', price: 49.99, quantity: 2 },
      { product_id: 2, name: 'Créatine Monohydrate', price: 24.99, quantity: 1 }
    ]);
  };
